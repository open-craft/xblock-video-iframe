...
"""
xblock-video-iframe documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-video-iframe',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/open-craft/xblock-video-iframe",
...
#
# html_title = 'xblock-video-iframe v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'XBlock to embed video content using iframe along with download buttons',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'video_iframe'),
                os.path.join(root_path, 'video_iframe/migrations')])
